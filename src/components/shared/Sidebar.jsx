...
function Sidebar() {
  const currentPath = '#'; // Placeholder for current route logic
  ...
  return (
    <>
      ...
      <button 
        ...
        className="md:hidden fixed top-4 left-4 z-40 p-2 rounded-lg bg-white/90 dark:bg-gray-800/90 shadow-sm border border-gray-100 dark:border-gray-700/60 backdrop-blur-sm"
      ...
      >
        <div className="flex flex-col w-64 h-full">
          <div className="flex flex-col h-full flex-1 bg-gradient-to-b from-white to-gray-50/80 dark:from-gray-800 dark:to-gray-900/95 border-r border-gray-100 dark:border-gray-800/50 shadow-lg">
            ...
            <div className="flex items-center justify-between py-6 px-6">
              <div className="flex items-center">
                ...
                <span className="ml-3 text-lg font-medium tracking-tight text-gray-900 dark:text-white">FitDash</span>
              </div>
              ...
              {isMobile && isOpen && (
                <motion.button 
                  ...
                  className="p-1.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700/70"
                  onClick={() => setIsOpen(false)}
                >
            ...
            <nav className="mt-4 px-3 flex-1">
              <div className="space-y-1">
                {navItems.map((item) => {
                  // Check both current prop and path
                  const isCurrent = item.current || item.href === currentPath;
                    ...
                    <motion.a
                      ...
                      className={clsx(
                        ...
                        isCurrent
                          ...
                          : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 hover:bg-gray-100/80 dark:hover:bg-gray-800/50 dark:hover:text-white'
                      )}
            ...
            <div className="px-3 pb-5 mt-auto">
              <div className="relative overflow-hidden rounded-xl backdrop-blur-sm">
                ...
                <div className="relative bg-white/80 dark:bg-gray-800/70 border border-gray-100/80 dark:border-white/5 rounded-xl p-5 backdrop-blur-sm shadow-sm">
